...
输出  : output/html/recovery_deck_swiss.html

位置: scripts/variants/recovery-deck/build.py
  · 与 output/html/deep_diagnosis_latest.html（标准版）共用同一份内容逻辑
...
# __file__ = <PROJECT_ROOT>/scripts/variants/recovery-deck/build.py
...
def main():
    ...
    out = out_dir / "recovery_deck_swiss.html"
